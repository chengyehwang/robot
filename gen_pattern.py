...
def main():
    ...
    parser.add_argument("-o", "--output", help="output file", default="out.jpg", action="store", dest="output")
    ...
    if True:
        page_width = (columns + 1) * square_size
        page_height = (rows + 1) * square_size
    global SVG_width
    global SVG_height
    SVG_width = page_width
    SVG_height = page_height
